...
KeyboardDriver::KeyboardDriver(InterruptManager* manager, KeyboardEventHandler* handler_)
...
uint32_t KeyboardDriver::HandleInterrupt(uint32_t esp) {
    ...
    if(key < 0x80)
    {
        switch (key) {
            ...
            case 0x03: if(Shift) handler->OnKeyDown('é'); else handler->OnKeyDown('2'); break;
            ...
            case 0x08: if(Shift) handler->OnKeyDown('è'); else handler->OnKeyDown('7'); break;
            case 0x09: if(Shift) handler->OnKeyDown('_'); else handler->OnKeyDown('8'); break;
            case 0x0A: if(Shift) handler->OnKeyDown('ç'); else handler->OnKeyDown('9'); break;
            case 0x0B: if(Shift) handler->OnKeyDown('à'); else handler->OnKeyDown('0'); break;
