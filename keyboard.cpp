...
uint32_t KeyboardDriver::HandleInterrupt(uint32_t esp) {
    ...
    if(key < 0x80)
    {
        switch (key) {
            ...
            case 0x03: if(Shift) printf("é"); else printf("2"); break;
            ...
            case 0x08: if(Shift) printf("è"); else printf("7"); break;
            case 0x09: if(Shift) printf("_"); else printf("8"); break;
            case 0x0A: if(Shift) printf("ç"); else printf("9"); break;
            case 0x0B: if(Shift) printf("à"); else printf("0"); break;
            ...
            default:
                if(key < 0x80) {
                    ...
                    foo[11] = hex[(interruptNumber >> 4) & 0xF];
                    foo[12] = hex[interruptNumber & 0xF];
                    printf(foo);
                }
                break;
            }
